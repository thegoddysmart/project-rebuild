...
import SuperAdminOrganizerActions from "../OrganizerActions";
...
export default async function SuperAdminOrganizerDetailsPage(props: Props) {
  ...
  // Helper to format events for the table if needed
  const formattedEvents = organizer.events.map((e: any) => ({
    ...e,
    startDate: e.startDate.toISOString(),
    endDate: e.endDate.toISOString(),
    votePrice: e.votePrice ? Number(e.votePrice) : null,
    totalRevenue: Number(e.totalRevenue),
    totalVotes: Number(e.totalVotes), // Ensure this is number if it wasn't
    stats: {
      votes: e.totalVotes,
          ...
          <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="p-4 space-y-4">
              ...
              <CommissionManager
                ...
                initialRate={Number(organizer.commissionRate)}
              />
            </div>
          </div>
